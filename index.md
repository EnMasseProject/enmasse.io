...
The <b>service admin</b> can deploy and manage messaging infrastructure using cloud-native tools, while <b>tenants</b> can request messaging resources using cloud-native APIs and tools. 
...
* Decouple <b>operation</b> of infrastructure from <b>use</b> by applications
...
EnMasse releases are available for download on our [GitHub](https://github.com/EnMasseProject/enmasse/releases) page. Docker images used in the releases are published to [Docker Hub](https://hub.docker.com/r/enmasseproject/).
